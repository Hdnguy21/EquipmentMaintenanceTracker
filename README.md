...
## Live Demo
🔗 **[View Live Demo](https://hdnguy21.pythonanywhere.com/)**

## Tech Stack
- **Frontend:** HTML5, CSS3, JavaScript
- **Backend:** Python (Flask)
- **Database:** CSV (flat-file storage)
...
The Equipment Maintenance Tracker is a factory node issue logging station and operational dashboard. It allows maintenance supervisors and technicians to log equipment faults, track issues by status and severity.
